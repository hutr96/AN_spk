    ...
    def train_model(self, train_scp, num_pertrain, num_GAN):
        ...
        with tf.Session() as session:
            ...
            for epoch in range(num_GAN):
                ...
                temp_savename = self.model_path + '/GAN_noise_spk_G_two_labels' + str(epoch) + '.ckpt'
                saver.save(session, save_path=temp_savename)
            saver.save(session, save_path=self.model_path + '/GAN_noise_spk_G_two_labels.ckpt')


result_path = '/mnt/hd5/hutr/GAN_DATA/result'

extname = 'noise_spk_G2'
...
scp_UBM = 'scp/UBM.scp'
my_model_name = my_modelpath + '/GAN_noise_spk_G_two_labels.ckpt'
